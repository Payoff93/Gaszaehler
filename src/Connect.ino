...
const char* ssid = "Wifiname";             // << kann bis zu 32 Zeichen haben
const char* password = "WifiPasswort";  // << mindestens 8 Zeichen jedoch nicht länger als 64 Zeichen
...
void Connect() {      // Funktionsaufruf "Connect();" muss im Setup eingebunden werden
  ...
  Serial.println("Esp8266 Gaszähler IP: " + WiFi.localIP().toString());
}
